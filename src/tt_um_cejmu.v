...
module wallace_tree(x, y, z);
  ...
  assign stage_5 = { \h2:341 , \h2:340 , \f2:298 , \f2:297 , \f1:289 , \f1:288 , \h1:333 , \h1:332  };
  assign stage_6 = { stage_4[3], \f5:325 , \f5:324 , \f4:316 , \f4:315 , \f3:307 , \f3:306 , \h3:349  };
  ...
  assign \h3:348  = _09_;
  assign \h3:349  = _10_;
  assign z = { _11_, \h3:348 , stage_5[0], stage_1[0] };
endmodule
