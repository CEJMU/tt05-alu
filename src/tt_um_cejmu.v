...
module barrel_shifter(x, y, z);
  ...
  assign mul0v = { 3'h0, x[0], x };
  assign mul1v = { 2'h0, x[0], x[1], 1'h0, x[3:1] };
  assign mul2v = { 1'h0, x[0], x[1], x[2], 2'h0, x[3:2] };
  assign mul3v = { x[0], x[1], x[2], x[3], 3'h0, x[3] };
  assign \mul0:552  = _0_;
  assign \mul1:558  = _1_;
  assign \mul2:564  = _2_;
  assign \mul3:570  = _3_;
  assign z = { \mul3:570 , \mul2:564 , \mul1:558 , \mul0:552  };
endmodule
...
module four_bit_comparator(x, y, z);
  ...
  assign equalv = { 1'hz, \onebitkomparator_1:434 , \onebitkomparator_2:446 , \onebitkomparator_3:458  };
  assign greater = _14_;
  assign smaller = _17_;
...
module multiplexer(a, s0, s1, d, y);
  ...
  assign _05_ = _04_ ? a[0] : _10_;
  assign _06_ = ~ s1;
  assign _07_ = _06_ & s0;
  assign _08_ = ~ d;
  assign _09_ = _08_ & _07_;
  assign _10_ = _09_ ? a[1] : _15_;
  assign _11_ = ~ s0;
  assign _12_ = s1 & _11_;
  assign _13_ = ~ d;
  assign _14_ = _13_ & _12_;
  assign _15_ = _14_ ? a[2] : _19_;
  assign _16_ = s1 & s0;
  assign _17_ = ~ d;
  assign _18_ = _17_ & _16_;
  assign _19_ = _18_ ? a[3] : _24_;
  assign _20_ = ~ s0;
  assign _21_ = ~ s1;
  assign _22_ = _21_ & _20_;
  assign _23_ = d & _22_;
  assign _24_ = _23_ ? a[0] : _28_;
  assign _25_ = ~ s1;
  assign _26_ = _25_ & s0;
  assign _27_ = d & _26_;
  assign _28_ = _27_ ? a[5] : _32_;
  assign _29_ = ~ s0;
  assign _30_ = s1 & _29_;
  assign _31_ = d & _30_;
  assign _32_ = _31_ ? a[6] : a[7];
  assign y = _05_;
endmodule
